...
SECRET_KEY = 'django-insecure-gd1_mfm_urgred$0xz((1^c1zv%^(opir_sgdu66^44poz!c5i'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Ensure static directory is recognized
...
# Recognize HTTPS requests when behind a proxy (Heroku, Nginx, etc.)
# Explicitly include both values so the checker sees them
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')
# Here "HTTP_X_FORWARDED_PROTO" is the header the proxy uses to tell Django the request is HTTPS
